...
export default function FhePlayground() {
        ...
        <div className="container relative z-10 px-4">
          ...
          >
            <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full bg-primary/10 border border-primary/20">
              ...
              <span className="text-xs font-black tracking-widest uppercase">Interactive FHE Demo</span>
            </div>
            ...
            <p className="text-base md:text-lg text-muted-foreground max-w-2xl mx-auto font-medium">
              See Fully Homomorphic Encryption in action. Perform calculations on encrypted numbers without ever decrypting them.
            </p>
          </motion.div>
        </div>
      </header>
          ...
          {activeTab === "how-it-works" && (
            ...
            >
                ...
                {[
                  {
                    step: 1,
                    title: "Encryption",
                    description: "Your data is encrypted using advanced FHE schemes (BFV, CKKS). Only you have the decryption key.",
                    icon: Lock,
                  },
                  {
                    step: 2,
                    title: "Computation",
                    description: "Operations (addition, multiplication) happen directly on encrypted data without decryption.",
                    icon: Zap,
                  },
                  {
                    step: 3,
                    title: "Result",
                    description: "The encrypted result is returned. You decrypt it with your private key to see the answer.",
                    icon: Unlock,
                  },
                  {
                    step: 4,
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="p-8 rounded-2xl bg-primary/10 border border-primary/20 space-y-4"
              >
                <div className="flex items-start gap-4">
                  <Code className="w-6 h-6 text-primary shrink-0 mt-1" />
                  <div>
                    <h4 className="font-black mb-2">Technical Details</h4>
          ...
          {activeTab === "use-cases" && (
            ...
            >
              <motion.div variants={container} initial="hidden" animate="show" className="grid md:grid-cols-2 gap-6">
                {[
                  ...
                  },
                  {
                    ...
                    description: "Meet GDPR, HIPAA, and other privacy regulations effortlessly.",
                    icon: "⚖️",
                  },
                  {
                    title: "Multi-Party Computation",
                    description: "Enable secure collaboration between organizations on sensitive data.",
                    icon: "🤝",
                  },
                ].map((useCase, idx) => (
                  <motion.div
              ...
              <motion.div
                initial={{ opacity: 0, y: 20 }}
                animate={{ opacity: 1, y: 0 }}
                className="p-8 rounded-2xl bg-gradient-to-r from-primary/10 to-blue-500/10 border border-primary/20 space-y-4"
              >
                ...
                <p className="text-muted-foreground">
                  FheDF brings the power of Fully Homomorphic Encryption to everyday PDF workflows. It's the first toolkit that allows you to process sensitive documents without ever decrypting them. Perfect for organizations that need to balance utility with privacy.
                </p>
              </motion.div>
            </motion.div>
          )}
